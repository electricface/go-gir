...
func (v FileLoader) LoadAsync(io_priority int32, cancellable g.ICancellable, fn func(v interface{}), fn1 func(v interface{})) {
	...
	arg_progress_callback := gi.NewPointerArgument(g.GetPointer_myFileProgressCallback())
	arg_fn := gi.NewPointerArgumentU(cId)
	arg_progress_callback_notify := gi.NewPointerArgument(g.GetPointer_myDestroyNotify())
